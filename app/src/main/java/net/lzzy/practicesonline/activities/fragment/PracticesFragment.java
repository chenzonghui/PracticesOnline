...
public class PracticesFragment extends BaseFragment {
    ...
    static class PracticeDownloader extends AsyncTask<Void,Void,String>{
        ...
        protected String doInBackground(Void... voids) {
            ...
            try {
                return PracticeService.getPracticesFrcomServer();
            } catch (IOException e) {
                return e.getMessage();
            }
        }
...
//                btnDel.setVisibility(View.GONE);
    ...
    private void performItemClick(Practice practice) {
        if (practice.isDownloaded()&&listener !=null){
            ...
            listener.onPricticesSelected(practice.getId().toString(),practice.getApiId());
        }else {
...
//                }
    ...
    private void initViews(){
        ...
        TextView tvNone= find(R.id.fragment_practices_none);
    ...
    public interface OnPracticesSelectedListener{
        void onPricticesSelected(String string, int apiId);
    }
}
