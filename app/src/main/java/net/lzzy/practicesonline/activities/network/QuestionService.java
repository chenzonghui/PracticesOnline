...
public class QuestionService {
    ...
    public static List<Question> getQuestions(String json, UUID practiceId) throws IllegalAccessException, JSONException, InstantiationException {
        ...
        for (Question question : questions) {
            question.setPracticeld(practiceId);
        }
        return questions;
    }

    public static List<Option> getOptionsFromJson(String jsonOptions, String jsonAnswerst) throws IllegalAccessException, JSONException, InstantiationException {
        JsonConverter<Option> converter=new JsonConverter<>(Option.class);
        List<Option> options=converter.getArray(jsonOptions);
        List<Integer> answerIds=new ArrayList<>();
        JSONArray array=(JSONArray)(new JSONTokener(jsonAnswerst)).nextValue();
